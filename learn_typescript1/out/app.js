...
let stringLab = 'Apple, Cat, Zoo, Bird, Dog';
let input = stringLab.split(', ').sort();
console.log(input);
let array2 = [123, 132, 423, 423, 12345, 5343, 52, 10904, 64];
console.log(array2.filter(item => (item + '').startsWith('1')));
let array3 = ["Apple", "Mango", "Cat", "Banana"];
...
let areaRectangle = (width, lengthh) => {
